...
<body>
    ...
    <div class="register">
        <p class="mb-2 p-1 border-bottom">Cadastrar Forncededor</p>
        <section class="bg-light p-3 rounded-3">
            <form method="POST" action="../controller/SupplierController.php?<?php echo $action ?>" class="d-flex flex gap-2 gap-sm-3 flex-wrap">
                <div class="form-group col-xl-2 col-12">
                    <input class="form-control" type="text" name="supplier" placeholder="Fornecedor">
                </div>
                <div class="form-group col-xl-2 col-12">
            ...
            <div>
                <ul class="list-group">
                    ...
                    foreach ($listSuppliers as $supplier) {
                        echo '
                            <li class="list-group-item d-flex justify-content-between align-items-center">' . $supplier->getSupplier() . ' | ' . $supplier->getCnpj() . '<span><a href="../controller/SupplierController.php?delete&id=' . $supplier->getId() . '" class="btn"><i class="bi bi-x"></i></a></span>
                            </li>
                        ';
                    }
                    ?>
